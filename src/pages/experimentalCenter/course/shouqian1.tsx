...
import mp4 from "./image2/WeChat_buchou4.mp4";
//@ts-ignore
...
function Shouqian1() {
  ...
  const { principal } = useSpring({
    from: { principal: 80000000 },

    to: { principal: startAnimation1 ? 80000000 : 30000000 },
    delay: 500,
    duration: 5000,
  });
  ...
  const { payable } = useSpring({
    from: { payable: 0 },
    to: { payable: startAnimation1 ? 50000000 : 0 },
    delay: 500,
    duration: 5000,
  });
  ...
  const next = () => {
    ...
    if (
      (text1 == "c5460c4a38f89b6f4cf36b4c85590f25ad6ee25f01" &&
        qian1 == "50000000") ||
      (text1 == "c5460c4a38f89b6f4cf36b4c85590f25ad6ee25f01" &&
        qian1 == "50,000,000")
    ) {
              ...
              <div style={{ width: "90%", marginRight: "0.5vw" }}>
                ...
                <p style={{ fontSize: "1vw", lineHeight: "1.8vw" }}>
                  {isModalOpen ? (
                    <TypingCard
                      source={
                        "场景角色：本流程中学员将扮演企业的财务部的角色<br/><br/>场景描述： 企业财务部门接收国库拨付中心的乡村振兴专项数字人民币资金到数字人民币账户，同时数据回转至地方监管部门和央行数人民币大数据中心，用于数据监管与比对。<br/><br/>实验操作步骤：学员需要分别在企业账户区域，输入对于“新优集团”资金账户所要的金额50,000,000元，对于“集悦集团”资金账户所要的金额25,000,000元，以及每个金额相对应的token。"
                      }
                    />
                  ) : (
                    ""
      ...
      >
        <Button
          onClick={() => {
            ...
            // next();
            startNext
              ? navigate("/admin/experimentalCenter/course/shouqian2")
