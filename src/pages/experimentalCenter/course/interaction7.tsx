...
import mp4 from "./image2/WeChat_buzhou7.mp4";
//@ts-ignore
...
function Interaction7() {
  ...
  const { principal } = useSpring({
    from: { principal: 5010000 },

    to: { principal: startAnimation1 ? 5010000 : 5000000 },
    delay: 500,
    duration: 5000,
  });
  const { principal1 } = useSpring({
    from: { principal1: 0 },
    to: { principal1: startAnimation1 ? 25000000 : 25010000 },
    delay: 500,
    duration: 5000,
  });
    ...
    <div style={{ position: "relative" }}>
      ...
      >
        <Form id="modalForm" form={form} onFinish={handleFormSubmit}>
          ...
          >
            <Input placeholder="请输入您的资金交易的实际用途" />
          </Form.Item>

          <Form.Item name="transactionAddress" label="交易地址">
              ...
              <div style={{ width: "90%", marginRight: "0.5vw" }}>
                ...
                <p style={{ fontSize: "1vw", lineHeight: "1.8vw" }}>
                  {isModalOpen ? (
                    <TypingCard
                      source={
                        "场景角色：本流程中学员将扮演自然人刘琦的角色<br/><br/>场景描述： 刘琦通过专项账户的数字人民币资金在线向”集悦集团“支付商品货款进行商品购买。<br/><br/> 实验操作步骤：学员需要分别在个人账户区域，输入对于企业购买商品的金额10,000元，以及每个金额相对应的token密钥"
                      }
                    />
                  ) : (
                    ""
