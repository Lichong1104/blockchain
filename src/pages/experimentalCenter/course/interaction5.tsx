...
function Interaction5() {
  ...
  const { principal1 } = useSpring({
    from: { principal1: 0 },
    to: { principal1: startAnimation1 ? 75000000 : 80000000 },
    delay: 500,
    duration: 5000,
  });
  ...
  const { payable2 } = useSpring({
    from: { payable2: 0 },
    to: { payable2: startAnimation1 ? 5000000 : 0 },
    delay: 500,
    duration: 5000,
  });
  const next = () => {
      ...
      sessionStorage.setItem(
        ...
        JSON.stringify([
          ...arr,
          {
            ...
            payee: "刘琦",
            amount: "5,000,000",
            token: "26186289e131960d37676f348cc3ee5c4c2fa09703",
          },
        ])
      );
    } else {
      ...
      >
        <Button
          onClick={() => {
            ...
            // next();
            startNext
              ? navigate("/admin/experimentalCenter/course/shouqian1")
